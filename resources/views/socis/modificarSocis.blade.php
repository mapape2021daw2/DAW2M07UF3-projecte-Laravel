...
@section('content')
    ...
    <div class="container col-5">
        <div class="content">
            <h2 style="text-align: center">MODIFICAR SOCI</h2>
            <form action="/modifySocisData" method="post" class="form-group">
                @csrf
                <label for="">NIF</label>
                ...
                <input class="form-control" type="telf" placeholder="Telèfon" name="telefon">
